class BackgroundSet {
	...
	_lazyLoadBackground = fileName => {
		...
		this._styleBodyBackgrond(this._dummyBodyBackgroundStyle, `url('assets/backgrounds/Bg.webp')`);
		...
		this._hqBackground.onload = () => {
			...
			this._styleBodyBackgrond(this._bodyStyle, `url('assets/backgrounds/Bg.webp')`);
		...
		setTimeout (
			() => {
				this._hqBackground.src = `assets/backgrounds/Bg.webp`;
			},
			500
		);
	}
